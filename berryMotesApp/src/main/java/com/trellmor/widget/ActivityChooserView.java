...
public class ActivityChooserView extends ViewGroup implements
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(com.trellmor.berrymotes.R.layout.abc_activity_chooser_view, this, true);

        mCallbacks = new Callbacks();

        mActivityChooserContent = (LinearLayoutCompat) findViewById(com.trellmor.berrymotes.R.id.activity_chooser_view_content);
        mActivityChooserContentBackground = mActivityChooserContent.getBackground();

        mDefaultActivityButton = (FrameLayout) findViewById(R.id.default_activity_button);
        mDefaultActivityButton.setOnClickListener(mCallbacks);
        mDefaultActivityButton.setOnLongClickListener(mCallbacks);
        mDefaultActivityButtonImage = (ImageView) mDefaultActivityButton.findViewById(com.trellmor.berrymotes.R.id.image_default);
        ...
        mExpandActivityOverflowButtonImage =
                (ImageView) expandButton.findViewById(com.trellmor.berrymotes.R.id.image_expand);
                ...
                case ITEM_VIEW_TYPE_FOOTER:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        convertView = LayoutInflater.from(getContext()).inflate(
                                com.trellmor.berrymotes.R.layout.abc_activity_chooser_view_list_item, parent, false);
